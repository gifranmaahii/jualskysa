...
const config = {
  ...
  APIkey: {
    ...
    fgsi: "ISI_FGSI_APIKEY_DISINI",
    google: "ISI_GOOGLE_APIKEY_DISINI",
    groq: "ISI_GROQ_APIKEY_DISINI", // API Key Groq untuk fitur transkrip (gratis di console.groq.com)
    betabotz: "ISI_BETABOTZ_APIKEY_DISINI",
    // kalian bisa daftar di https://covenant.sbs, dan ambil apikeynya
    covenant: "ISI_COVENANT_APIKEY_DISINI",
  },
};
